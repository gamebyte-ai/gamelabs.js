import type { TimeConfig, TimeDisplayFormat } from "../BlockPuzzleConfig";
 ...
 * elapsed value; `format` renders the resulting seconds value as
 * the configured string ({@link TimeConfig.displayFormat}).
 *
 ...
 *
 * Lifted from Solitaire's TimeFormatter — the formatting math is
 * game-agnostic.
 */
