...
export enum GameState {
   ...
   *  controller layer; the HUD shows a Game Over label. */
  GameOver = "gameOver",
}
 ...
 * {@link GameScreenViewController} to drive the Game Over HUD.
 *
 * Transitions are caller-validated (no enforced state-machine
 * here): App moves Dealing→Playing in the deal-animation callback;
 * the screen controller moves Playing→GameOver when the configured
